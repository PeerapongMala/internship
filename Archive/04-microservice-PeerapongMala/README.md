[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=15486481)
...
- Start Forex-service by running `SpringBootMicroserviceForexServiceApplication` as 2 instances. This application should now register itself to Eureka Server 

:octocat::octocat:In VSCode, you have to add the following in launch.json (by going to `Run and Debug` tab on the left hand) so that there will be 2 instances, one for 8000 and another for 8001

```
 {
    "type": "java",
    "name": "Launch 1SpringBootMicroserviceForexServiceApplication",
    "request": "launch",
...
{
    "type": "java",
    "name": "Launch 2SpringBootMicroserviceForexServiceApplication2",
    "request": "launch",
...
- Start Currency-conversion by running `SpringBootMicroserviceCurrencyConversionApplication` as Java application. 
