namespace BSS_WEB.Models.Report.Preparation
{
    ...
    public class PreparationUnsortCANonMemberReportModel
    {
        ...
        public ICollection<PreparationUnsortCANonMemberReportDetail> ReportDetail { get; set; } = new List<PreparationUnsortCANonMemberReportDetail>();

        public PreparationUnsortCANonMemberReportSummary ReportSummary { get; set; } = new PreparationUnsortCANonMemberReportSummary();
    }
    ...
    public class PreparationUnsortCANonMemberReportSummary
    {
        ...
        public ICollection<PreparationUnsortCANonMemberReportSummaryDetail> ReportSummaryDetail { get; set; } = new List<PreparationUnsortCANonMemberReportSummaryDetail>();
    }
