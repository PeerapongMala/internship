...
namespace BSS_API.Services.Interface
{
    ...
    public interface IMasterDropDownService
    {
        ...
        Task<ICollection<DropDownItemResponse<MasterDenoUnsortCcViewData>>> GetDenominationByInstitutionIdAsync(SystemSearchRequest request);

        Task<ICollection<DropDownItemResponse<MasterShift>>> GetDropDownShiftItemAsync(SystemSearchRequest request);
    }
}