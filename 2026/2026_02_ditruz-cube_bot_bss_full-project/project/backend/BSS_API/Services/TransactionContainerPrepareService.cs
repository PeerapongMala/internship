namespace BSS_API.Services
{
    ...
    public class TransactionContainerPrepareService : ITransactionContainerPrepareService
    {
        ...
        public async Task<TransactionContainerPrepareViewData> GetContainerPrepareById(long Id)
        {
            ...
            var entity =
                await _unitOfWork.TransactionContainerPrepareRepos.GetAsync(item => item.ContainerPrepareId == Id);
            if (entity != null)
            {
        ...
        {
            var entity_row =
                await _unitOfWork.TransactionContainerPrepareRepos.GetAsync(item =>
                    item.ContainerPrepareId == request.ContainerPrepareId);
        ...
        public async Task<IEnumerable<TransactionContainerPrepare>> GetContainerPrepareByUniqueOrKey(
            string containerCode)
        {
            return await _unitOfWork.TransactionContainerPrepareRepos.GetAllAsync(item =>
