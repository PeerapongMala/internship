    ...
    public class BssReportService(IUnitOfWork unitOfWork) : IBssReportService
    {
            ...
            RegisterUnsortReportRequest registerUnsortReportRequest)
        {
            try
            {
                ...
                registerUnsortReportModel.ReportHeader.RegisterDate = transactionRegisterUnsort.CreatedDate != null
                    ? transactionRegisterUnsort.CreatedDate.ToString("dd/MM/yyyy")
                    : string.Empty;
