namespace BSS_API.Models.Common;
...
public class ApiResponse
{
    ...
    /// <summary>Message / ข้อความ</summary>
    public string Message { get; set; } = string.Empty;

    /// <summary>Error code (optional) / รหัส error</summary>
