namespace BSS_API.Models.Entities
{
    ...
    [Table("bss_txn_approve_manual_key_in")]
    public class TransactionApproveManualKeyIn
    {
        [Key, Column("approve_manual_key_in_id")] public long ApproveManualKeyInId { get; set; }

        #region TransactionApproveManualKeyInTran

        [Column("approve_manual_key_in_tran_id")]
        [ForeignKey("TransactionApproveManualKeyInTran")]
        public long ApproveManualKeyInTranId { get; set; }

        public TransactionApproveManualKeyInTran? TransactionApproveManualKeyInTran { get; set; }

        #endregion TransactionApproveManualKeyInTran
