namespace BSS_API.Models.Entities
{
    ...
    [Table("bss_txn_verify")]
    public class TransactionVerify
    {
        [Key, Column("verify_id")] public long VerifyId { get; set; }

        #region TransactionVerifyTran

        [Column("verify_tran_id")]
        [ForeignKey("TransactionVerifyTran")]
        public long VerifyTranId { get; set; }

        public TransactionVerifyTran? TransactionVerifyTran { get; set; }

        #endregion TransactionVerifyTran
