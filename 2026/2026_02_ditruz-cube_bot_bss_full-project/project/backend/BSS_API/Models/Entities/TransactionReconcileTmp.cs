namespace BSS_API.Models.Entities
{
    ...
    [Table("bss_txn_reconcile_tmp")]
    public class TransactionReconcileTmp
    {
        [Key, Column("reconcile_tmp_id")] public long ReconcileTmpId { get; set; }
        ...
        [Column("is_machine_result")] public bool? IsMachineResult { get; set; }
