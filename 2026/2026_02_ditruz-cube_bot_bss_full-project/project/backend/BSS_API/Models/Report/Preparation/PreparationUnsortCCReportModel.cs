namespace BSS_API.Models.Report.Preparation
{
    ...
    {
        public string ReportTitle { get; set; } = BssReportConstants.PreparationUnsortCCReportName;

        public PreparationUnsortCCReportHeader ReportHeader { get; set; } = new();

        public ICollection<PreparationUnsortCCReportDetail> ReportDetail { get; set; } =
            new List<PreparationUnsortCCReportDetail>();
    ...
    public class PreparationUnsortCCReportSummary
    {
        ...
        public ICollection<PreparationUnsortCCReportSummaryDetail> ReportSummaryDetail { get; set; } =
            new List<PreparationUnsortCCReportSummaryDetail>();
    }
