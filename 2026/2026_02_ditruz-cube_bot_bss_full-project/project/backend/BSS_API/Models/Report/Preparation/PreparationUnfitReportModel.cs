namespace BSS_API.Models.Report.Preparation
{
    ...
    public class PreparationUnfitReportModel
    {
        ...
        public ICollection<PreparationUnfitReportDetail> ReportDetail { get; set; } =
            new List<PreparationUnfitReportDetail>();
    ...
    public class PreparationUnfitReportSummary
    {
        ...
        public ICollection<PreparationUnfitReportSummaryDetail> ReportSummaryDetail { get; set; } =
            new List<PreparationUnfitReportSummaryDetail>();
    }
