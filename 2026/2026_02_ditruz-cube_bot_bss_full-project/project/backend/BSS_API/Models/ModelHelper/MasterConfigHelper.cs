namespace BSS_API.Models.ModelHelper
{
    ...
    public static class MasterConfigHelper
    {
            ...
            int? day = null)
        {
            ...
            var defaultHours = TimeSpan.Parse(masterConfigs
                .First(w => w.ConfigCode == ConfigConstants.BSS_WORK_START_TIME).ConfigValue ?? "08:00:00");

            DateTime defaultStartDate = DateTime.Now.AddHours(-defaultHours.TotalHours).Date;
            return defaultStartDate.Add(defaultHours);
        }
            ...
            int? day = null)
        {
            ...
            DateTime defaultEndDate = DateTime.Now.AddDays(defaultDay).AddHours(-defaultHours.TotalHours).Date;
            return defaultEndDate.Add(defaultHours);
        }
