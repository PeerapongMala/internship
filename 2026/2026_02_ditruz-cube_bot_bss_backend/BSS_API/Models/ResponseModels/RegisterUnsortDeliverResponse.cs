namespace BSS_API.Models.ResponseModels
{
    ...
    public class RegisterUnsortDeliverResponse
    {
        ...
        public ICollection<MasterInstitution?> MasterInstitution { get; set; } = new List<MasterInstitution?>();

        public ICollection<MasterStatus?> MasterStatus { get; set; } = new List<MasterStatus?>();
