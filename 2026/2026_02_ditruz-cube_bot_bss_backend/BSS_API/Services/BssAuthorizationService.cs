...
namespace BSS_API.Services
{
    public class BssAuthorizationService : IBssAuthorizationService
    {
        ...
        public async Task<UserAuthorizationData> CheckUserAuthorizationAsync(string usernameId)
        {
            ...
            var logLogin = new TransactionUserLoginLog();
            logLogin.DepartmentId = userCompanyDepartmentInfo.DepartmentId;
            logLogin.UserId = userInfo.UserId;
            logLogin.MachineId = null;
            logLogin.FirstLogin = DateTime.Now;
            logLogin.LastLogin = null;
            logLogin.Remark = null;
            logLogin.IsActive = true;
            logLogin.CreatedBy = userInfo.UserId;
            logLogin.CreatedDate = DateTime.Now;

            await _unitOfWork.TransUserLoginLogRepos.AddAsync(logLogin);
