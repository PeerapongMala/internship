    ...
    public class UnsortReceiveDeliveryService(IUnitOfWork unitOfWork) : IUnsortReceiveDeliveryService
    {
          ...
          CancellationToken ct = default)
        {
            ...
            foreach (var header in data)
            {
                ...
                header.CanEdit = isDifferentUser && !isAnyItemUsedInHeader;
                header.CanDelete = isDifferentUser && !isAnyItemUsedInHeader;
                ...
                if (header.ContainerData != null)
                {
                    foreach (var container in header.ContainerData)
                    {
                        ...
                        container.CanEdit = isDifferentUser && !isAnyItemUsedInContainer;
                        container.CanDelete = isDifferentUser && !isAnyItemUsedInContainer;
