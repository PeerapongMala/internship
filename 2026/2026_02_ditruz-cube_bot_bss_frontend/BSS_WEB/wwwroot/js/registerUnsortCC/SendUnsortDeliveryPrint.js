...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (container) {
            ...
            await window.exportPdfByPlaywright(content, 'SendUnsortDelivery_Report', true);
        }
    } catch (error) {
...
async function exportData() {
    ...
    if (type === "pdf") {
        ...
        if (container) {
            ...
            await window.exportPdfByPlaywright(content, 'SendUnsortDelivery_Report', false);
        }
    } else if (type === "excel") {
...
//    window.location.href = `/Report/SendUnsortDeliveryExportToExcel${window.location.search}`;
//}
...
async function exportExcelFromHtml() {
    ...
    try {
        ...
        form.method = 'POST';
        form.action = '/Report/SendUnsortDeliveryExportToExcel';
