...
{
    public class ReconciliationDetailResult
    {
        public long ReconciliationTranId { get; set; }
        public string? HeaderCardCode { get; set; }
        public List<ReconciliationDenominationDetailResult>? Denominations { get; set; }
        public int? TotalQty { get; set; }
        public int? TotalValue { get; set; }
    }

    public class ReconciliationDenominationDetailResult
    {
