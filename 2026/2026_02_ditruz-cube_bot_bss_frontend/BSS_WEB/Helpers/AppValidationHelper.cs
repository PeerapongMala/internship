...
namespace BSS_WEB.Helpers
{
    public class AppValidationHelper
    {
        ...
        {
<<<<<<< HEAD
            // TODO: Replace with actual role validation logic
            // Example: Only Supervisor, Manager roles can approve
            // roleCode should be "Supervisor", "Manager", etc.

            // ===== TESTING MODE: Bypass validation =====
            // TEMPORARY: Allow all users for mock data testing
            // TODO: Uncomment real validation when testing with real DB
            return true;
