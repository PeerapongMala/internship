...
import QuizDemo from './quiz-demo-old';

const DomainG04D03P01GameplayQuizRoute: HelperArchitectureDomainInterface['RouteInterface'] =
  {
    I18N: I18NInit,
    JSX: DomainJSX,
    Route: HelperTanStackRouter.JSX.Mapping({
      JSX: QuizDemo,
      routePathSub: '/quiz-demo',
    }),
    GameInitial,
  };
export default DomainG04D03P01GameplayQuizRoute;
