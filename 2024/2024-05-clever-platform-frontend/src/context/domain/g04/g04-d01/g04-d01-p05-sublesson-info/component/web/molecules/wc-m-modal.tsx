...
import SafezonePanel from '../atoms/wc-a-safezone-panel';
import styles from './wc-m-modal.module.css';
  ...
  return (
    <>
      ...
      >
        <div
          id="modal-root"
          className={`justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 outline-none focus:outline-none ${styles['modal']} ${styles['modal-transition']} ${
            isVisible
          ...
          ref={modalRef}
        >
          <div className={`bg-white/80 rounded-[60px] p-2 pb-4 ${className ?? ''}`}>
            <div
      ...
      {overlay && (
        <div
          id="modal-overlay"
          className={`absolute inset-0 bg-black/40 top-0 left-0 w-full h-full transition-opacity duration-700 ${
