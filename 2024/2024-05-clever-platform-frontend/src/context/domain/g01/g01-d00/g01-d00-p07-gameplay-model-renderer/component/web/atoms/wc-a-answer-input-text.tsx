...
const AnswerText = ({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="flex justify-center items-center bg-white h-full w-full rounded-[30px] text-center px-4 font-medium">
        {choice && (
        ...
        {onCanceled && (
          <img
            className="absolute h-6 cursor-pointer px-2 top-[-10%] right-[-10%]"
