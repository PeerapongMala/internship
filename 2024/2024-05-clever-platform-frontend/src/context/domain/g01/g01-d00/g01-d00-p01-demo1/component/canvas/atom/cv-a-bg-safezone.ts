...
export class CVABGSafeZone extends CanvasComponent<EngineThreeGameLoopPropsInterface> {
  ...
  Update = (
    ...
    const scalerWidth = canvasScaler.mapping.widthCal(1440);
    const scalerHeight = canvasScaler.mapping.heightCal(810);
    ...
    canvasScaler?.draw.drawImage(
      { image: this.imageBG, x: 0, y: 0, width: 1440, height: 810 },
      true,
    );
