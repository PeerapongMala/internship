...
import { CVATweenTest } from '../component/canvas/atom/cv-a-tween-test';
import { GCACube } from '../component/game/atom/gc-a-cube';
import ConfigJson from '../config/index.json';

class SceneStateG001Demo1 extends SceneState<EngineThreeGameLoopPropsInterface> {
  ...
  Start = (props: EngineThreeGameLoopPropsInterface) => {
    ...
    //   context.scene.add(this.gcaCube.cube);
    // }
...
const GameInitial = SceneStateG001Demo1;
