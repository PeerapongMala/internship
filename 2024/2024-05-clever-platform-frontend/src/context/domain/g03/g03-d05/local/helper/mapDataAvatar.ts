...
export const createAvatarMapper = (tFunction: any = null) => {
  return (avatar: AvatarResponse): AvatarOutput => {
    ...
    console.log('Avatar response from mapdata: ', avatar);
    ...
    return {
      ...
      buy: avatar.is_bought, // Directly use the boolean
      lock: avatar.model_id !== 'set1_character1_level1' ? !avatar.is_bought : false, // Ensure first avatar is unlocked
