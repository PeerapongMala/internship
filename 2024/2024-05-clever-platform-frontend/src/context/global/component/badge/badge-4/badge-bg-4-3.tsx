...
const BadgeBg4_3: FC<{ className?: string }> = ({
  className,
}: {
  className?: string;
}) => {
  return (
    <svg
      ...
      className={className}
    >
      <g filter="url(#filter0_dd_11026_90691)">
        <g clip-path="url(#clip0_11026_90691)">
          <mask id="path-1-inside-1_11026_90691" fill="white">
          ...
          <path
            ...
            fill="url(#paint0_linear_11026_90691)"
          />
          <mask id="path-3-inside-2_11026_90691" fill="white">
          ...
          <path
            ...
            fill="black"
            fill-opacity="0.05"
            mask="url(#path-3-inside-2_11026_90691)"
          />
        </g>
        <path
          ...
          fill="#77DB82"
          mask="url(#path-1-inside-1_11026_90691)"
        />
      </g>
      <defs>
        <filter
          id="filter0_dd_11026_90691"
          x="0"
          y="7"
          width="230"
          height="64"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_11026_90691"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_11026_90691"
            result="effect2_dropShadow_11026_90691"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_11026_90691"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_11026_90691"
          x1="115"
          y1="7"
          x2="115"
          y2="55"
