...
const BadgeBg5_4: FC<{ className?: string }> = ({
  className,
}: {
  className?: string;
}) => {
  return (
    <svg
      ...
      className={className}
    >
      <g filter="url(#filter0_dd_11555_40344)">
        <g clip-path="url(#clip0_11555_40344)">
          <mask id="path-1-inside-1_11555_40344" fill="white">
          ...
          <path
            ...
            fill="url(#paint0_linear_11555_40344)"
          />
          <mask id="path-3-inside-2_11555_40344" fill="white">
          ...
          <path
            ...
            fill="black"
            fill-opacity="0.05"
            mask="url(#path-3-inside-2_11555_40344)"
          />
        </g>
        <path
          ...
          fill="#ACE4F2"
          mask="url(#path-1-inside-1_11555_40344)"
        />
      </g>
      <defs>
        <filter
          id="filter0_dd_11555_40344"
          x="0"
          y="7"
          width="230"
          height="64"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_11555_40344"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_11555_40344"
            result="effect2_dropShadow_11555_40344"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_11555_40344"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_11555_40344"
          x1="115"
          y1="7"
          x2="115"
          y2="55"
