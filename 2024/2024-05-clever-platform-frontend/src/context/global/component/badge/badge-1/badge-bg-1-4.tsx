...
const BadgeBg1_4: FC<{ className?: string }> = ({
  className,
}: {
  className?: string;
}) => {
  return (
    <svg
      ...
      className={className}
    >
      <g filter="url(#filter0_dd_11026_90676)">
        <g clip-path="url(#clip0_11026_90676)">
          <mask id="path-1-inside-1_11026_90676" fill="white">
          ...
          <path
            ...
            fill="url(#paint0_linear_11026_90676)"
          />
          <mask id="path-3-inside-2_11026_90676" fill="white">
            <path d="M8 31C8 17.7452 18.7452 7 32 7H198C211.255 7 222 17.7452 222 31C222 44.2548 211.255 55 198 55H32C18.7452 55 8 44.2548 8 31Z" />
          </mask>
          <path
            ...
            fill="black"
            fill-opacity="0.05"
            mask="url(#path-3-inside-2_11026_90676)"
          />
        </g>
        <path
          ...
          fill="#ACE4F2"
          mask="url(#path-1-inside-1_11026_90676)"
        />
      </g>
      <defs>
        <filter
          id="filter0_dd_11026_90676"
          x="0"
          y="7"
          width="230"
          height="64"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_11026_90676"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_11026_90676"
            result="effect2_dropShadow_11026_90676"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_11026_90676"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_11026_90676"
          x1="115"
          y1="7"
          x2="115"
          y2="55"
