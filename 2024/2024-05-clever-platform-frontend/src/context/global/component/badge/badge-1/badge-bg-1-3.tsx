...
const BadgeBg1_3: FC<{ className?: string }> = ({
  className,
}: {
  className?: string;
}) => {
  return (
    <svg width="230" height="71" viewBox="0 0 230 71" fill="none" className={className}>
      <g filter="url(#filter0_dd_11026_90675)">
        <g clip-path="url(#clip0_11026_90675)">
          <mask id="path-1-inside-1_11026_90675" fill="white">
          ...
          <path
            ...
            fill="url(#paint0_linear_11026_90675)"
          />
          <mask id="path-3-inside-2_11026_90675" fill="white">
            <path d="M8 31C8 17.7452 18.7452 7 32 7H198C211.255 7 222 17.7452 222 31C222 44.2548 211.255 55 198 55H32C18.7452 55 8 44.2548 8 31Z" />
          </mask>
          <path
            ...
            fill="black"
            fill-opacity="0.05"
            mask="url(#path-3-inside-2_11026_90675)"
          />
        </g>
        <path
          ...
          fill="#77DB82"
          mask="url(#path-1-inside-1_11026_90675)"
        />
      </g>
      <defs>
        <filter
          id="filter0_dd_11026_90675"
          x="0"
          y="7"
          width="230"
          height="64"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_11026_90675"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_11026_90675"
            result="effect2_dropShadow_11026_90675"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_11026_90675"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_11026_90675"
          x1="115"
          y1="7"
          x2="115"
          y2="55"
