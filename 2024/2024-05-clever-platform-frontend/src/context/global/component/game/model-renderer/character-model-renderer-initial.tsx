...
import { GCAThreeModel } from '../three-d-model/character-animation-controller-initial';

export function ThreeModelRenderer({
  modelSrc,
  className,
  style,
  canvasWidth = 800, // Add default width
  canvasHeight = 500, // Add default height
  ...
  useEffect(() => {
    ...
    // Clean up on unmount
    return () => {
      console.log('Cleanup: removing model from scene (Initial Renderer)');
