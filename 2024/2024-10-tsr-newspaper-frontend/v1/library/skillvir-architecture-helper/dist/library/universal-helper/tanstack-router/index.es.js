...
var F = Object.defineProperty,
  S = (o, e, t) =>
    e in o
      ...
      : (o[e] = t),
  n = (o, e, t) => S(o, typeof e != 'symbol' ? e + '' : e, t);
const T = (o) => (e) => (t) =>
    a({
      getParentRoute: () => t,
      ...
      n(this, 'RouteRoot', {
        ...
        Create: (t) => {
          ...
          return (
            ...
            this.Router.Set(s({ routeTree: this.routeRoot })),
            this.routeRoot
          );
        },
        Bind: (t) =>
...
const L = (o) => {
    ...
    return (
      o.template &&
        (e = /* @__PURE__ */ u(o.template, { children: /* @__PURE__ */ u(c, {}) })),
      /* @__PURE__ */ m(R, {
        children: [e, o.tanStackRouterDevtoolsIs && /* @__PURE__ */ u(d, {})],
      })
    );
  },
  B = {
