...
interface ImageBannerListProps {
...
const ImageBannerList: React.FC<ImageBannerListProps> = ({
  imageBannerList,
  fileDragging,
  fileDropping,
  onDragStart,
  ...
  return (
    <div className="flex gap-[11px] flex-wrap overflow-y-auto max-h-[504px] p-2 pb-3 md:flex-nowrap md:h-[180px] md:overflow-x-auto md:overflow-y-hidden whitespace-nowrap mb-[84px]">
      {imageBannerList.map((fileData, index) => (
        <div
          key={fileData.id || index}
          className={`relative w-[298px] h-[160px] flex flex-col items-center bg-[#D9A84E] border rounded cursor-move select-none ${
        ...
        >
          ...
          <div className="flex-shrink-0 w-[298px] h-[160px]">
            <img
...
export default ImageBannerList;
