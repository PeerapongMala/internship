...
const Setting = () => {
  ...
  const themeConfig = { theme, menu, semidark, layout, rtlClass, navbar, animation };
  return (
    <div>
      <div
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().themeToggle('light')}
              >
              ...
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().themeToggle('dark')}
              >
              ...
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().themeToggle('system')}
              >
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().toggleMenu('horizontal')}
              >
                Horizontal
              </button>
              ...
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().toggleMenu('vertical')}
              >
                Vertical
              </button>
              ...
              <button
                ...
                onClick={() =>
                  StoreVristoPersist.MethodGet().toggleMenu('collapsible-vertical')
                }
              >
                Collapsible
              </button>
            ...
            <div className="mt-5 text-primary">
              <label className="mb-0 inline-flex">
                <input
                  ...
                  checked={
                    themeConfig.semidark === true || themeConfig.semidark === 'true'
                  }
                  onChange={(e) =>
                    StoreVristoPersist.MethodGet().semidarkToggle(e.target.checked)
                  }
                />
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                onClick={() =>
                  StoreVristoPersist.MethodGet().layoutToggle('boxed-layout')
                }
              >
                Box
              </button>
              ...
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().layoutToggle('full')}
              >
                Full
              </button>
            </div>
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().rtlToggle('ltr')}
              >
                LTR
              </button>
              ...
              <button
                ...
                onClick={() => StoreVristoPersist.MethodGet().rtlToggle('rtl')}
              >
                RTL
              </button>
            </div>
            ...
            <div className="mt-3 flex items-center gap-3 text-primary">
              <label className="mb-0 inline-flex">
                <input
                  ...
                  onChange={() =>
                    StoreVristoPersist.MethodGet().navbarToggle('navbar-sticky')
                  }
                />
                <span>Sticky</span>
              </label>
              <label className="mb-0 inline-flex">
                <input
                  ...
                  className="form-radio"
                  onChange={() =>
                    StoreVristoPersist.MethodGet().navbarToggle('navbar-floating')
                  }
                />
                <span>Floating</span>
              </label>
              <label className="mb-0 inline-flex">
                <input
                  ...
                  className="form-radio"
                  onChange={() =>
                    StoreVristoPersist.MethodGet().navbarToggle('navbar-static')
                  }
                />
                <span>Static</span>
              </label>
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <div className="mt-3">
              <select
                ...
                onChange={(e) =>
                  StoreVristoPersist.MethodGet().animationToggle(e.target.value)
                }
              >
