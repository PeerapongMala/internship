...
interface CWModalQuestionInfoSortingProps extends ModalProps {
  title: string;
  open: boolean;
  onClose: () => void;
}

const CWModalQuestionInfoSorting = ({
  title,
  open,
  onClose,
}: CWModalQuestionInfoSortingProps) => {
              ...
              {openQuestion === question.id && (
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      {question.correct_answer.map((a, i) => (
                        <div className="flex text-sm text-neutral-900">
                          <div className="w-1/3">#{i + 1}</div>
                          <div className="w-2/3 break-words">{a}</div>
                        </div>
                      ))}
                    </div>
...
export default CWModalQuestionInfoSorting;
