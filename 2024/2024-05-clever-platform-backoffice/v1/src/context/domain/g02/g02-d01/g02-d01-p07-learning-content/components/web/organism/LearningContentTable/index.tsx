...
const LearningContentTable = ({ initialRecords }: LearningContentTableProps) => {
          ...
          <tbody>
            {recordsData.length > 0 ? (
              recordsData.map((data: any, index: number) => {
                return (
                  <tr
                    key={data.Content[0].Standard[0].LearningContent[0].LearningContentId}
                  >
                    ...
                    <td>
                      {data.Content[0].Standard[0].LearningContent[0].LearningContentId}
                    </td>
                    <td>
