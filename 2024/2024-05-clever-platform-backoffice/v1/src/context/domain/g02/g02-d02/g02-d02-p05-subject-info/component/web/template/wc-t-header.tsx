...
export default function ManageSubjectHeader() {
    ...
    <div className="flex flex-col gap-y-6">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-x-4">
          ...
          <div className="text-2xl font-bold">จัดการหลักสูตร</div>
        </div>

        <div className="text-black">สร้างหลักสูตร/วิชา เพื่อจัดการโครงสร้างหลักสูตร</div>
      </div>
