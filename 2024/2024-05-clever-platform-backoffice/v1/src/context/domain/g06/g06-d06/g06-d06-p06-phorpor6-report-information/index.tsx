...
import Phorpor6ReportInfoDocument from './component/web/organism/Phorpor6ReportInfoDocument';
...
const DomainJSX = () => {
  ...
  const initialFormValues = useStore.studentDetail(
    studentDetailSelectors.getPhorpor6InforForm,
  );
  ...
  return (
    <PP6Layout>
      <Phorpor6ReportInfoDocument form={form} />
    </PP6Layout>
  );
};
