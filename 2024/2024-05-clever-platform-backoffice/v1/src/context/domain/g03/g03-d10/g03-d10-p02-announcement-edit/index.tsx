...
const EditAnnouncement = () => {
  ...
  useEffect(() => {
    const updateLayout = () => {
      ...
      if (
        isMobile &&
        window.location.pathname !== '/line/teacher/announcement/edit/$announceId'
      ) {
        navigator({ to: '/line/teacher/announcement/edit/$announceId' });
      }
    };
          ...
          <div className="w-full max-w-[360px]">
            {announcementData.announcement_image || announcementData.image_url ? (
              ...
              >
                ...
                <p className="text-sm">.jpg, .png | ขนาดไม่เกิน 5 MB</p>
              </label>
            )}
            <input
              id="upload-image"
