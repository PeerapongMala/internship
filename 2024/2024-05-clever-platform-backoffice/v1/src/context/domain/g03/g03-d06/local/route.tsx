...
import DomainG03D06P08Route from '../g03-d06-p08-template-edit-template/route';
...
const domainList = (routePath: string) => [
  ...
  { domain: DomainG03D06P04Route, routePath: `${routePath}/homework` },
  { domain: DomainG03D06P05Route, routePath: `${routePath}/homework/$subjectId` },
  { domain: DomainG03D06P06Route, routePath: `${routePath}/homework/$subjectId/create` },
  {
    domain: DomainG03D06P07Route,
    routePath: `${routePath}/homework/$subjectId/edithomework/$homeworkId`,
  },
  {
