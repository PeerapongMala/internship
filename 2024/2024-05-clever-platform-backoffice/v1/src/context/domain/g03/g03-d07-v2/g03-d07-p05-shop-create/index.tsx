...
const DomainJSX = () => {
  ...
  useEffect(() => {
    const updateLayout = () => {
      ...
      if (
        isMobile &&
        window.location.pathname !== '/line/teacher/reward/store/coupon/create'
      ) {
    ...
    <div className="w-full">
      <CWBreadcrumbs
        links={[
          ...
          { label: 'จัดการรางวัล', href: '/teacher/reward/store/coupon' },
          { label: 'สร้างรางวัลในร้านค้า', href: '/teacher/reward/store/coupon/create' },
        ]}
      />
      <div className="my-5">
          ...
          <CWWhiteBox>
            <div className="w-full">
              ...
              <div className="mt-5 grid grid-cols-2 gap-5">
                ...
                />
                <SelectUserSubjectData label="วิชา" />
                <CWInput
                  label={'คำอธิบาย'}
                  required={false}
              ...
              <div className="mt-5 grid w-full grid-cols-3 gap-5">
                ...
                <div className="col-span-3 flex flex-col gap-2 md:col-span-1">
                  <CWInput
                    ...
                    required={true}
                    type={'number'}
                    value={formData.initial_stock_unlimited ? '' : formData.initial_stock}
                    onChange={(e) =>
