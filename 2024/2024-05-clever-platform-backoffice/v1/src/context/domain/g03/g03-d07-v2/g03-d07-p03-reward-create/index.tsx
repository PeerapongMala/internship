...
const DomainJSX = () => {
  ...
  useEffect(() => {
    const updateLayout = () => {
      ...
      if (isMobile && window.location.pathname !== '/line/teacher/reward/free/create') {
        navigate({ to: '/line/teacher/reward/free/create' });
      }
    };
    updateLayout();
    ...
    <div className="w-full">
      <CWBreadcrumbs
        links={[
          ...
          { label: 'จัดการรางวัล', href: '/teacher/reward/free' },
          { label: 'สร้างรางวัลฟรี', href: '/teacher/reward/free/create' },
        ]}
      />
      <div className="my-5">
