...
import { RewardRepository, FilterQueryParams } from '../../../repository';
...
const RestAPIGamification: RewardRepository = {
  ...
  CreateReward: function (data: CreateReward): Promise<PaginationAPIResponse<any>> {
    ...
    return fetchWithAuth(url, {
      ...
      .then((res: PaginationAPIResponse<any[]>) => {
        ...
        if (res.status_code === 201 && Array.isArray(res.data))
          return { ...res, data: res.data?.at(0) } as PaginationAPIResponse<any>;
        return res as PaginationAPIResponse<any>;
      });
  },
