import { CreatedTeacherRecord } from '@domain/g01/g01-d04/local/type';
import { Control, Controller, UseFormRegister } from 'react-hook-form';
import CWModalResetPassword from '@component/web/cw-modal/cw-modal-reset-password';
import IconFacebook from '@core/design-system/library/vristo/source/components/Icon/IconFacebook';
import CWInput from '@component/web/cw-input';
import { useState } from 'react';
import showMessage from '@global/utils/showMessage';
import API from '@domain/g01/g01-d04/local/api';

interface FormTeacherAccountProps {
  teacherId: string;
...
export default function FormTeacherAccount({
  teacherId,
  register,
  control,
}: FormTeacherAccountProps) {
