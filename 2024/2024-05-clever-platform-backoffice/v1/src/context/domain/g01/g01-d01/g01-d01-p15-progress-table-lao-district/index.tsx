...
const ProgressTableLaoDistrict = () => {
  const navigate = useNavigate();
  const { province, district } = useParams({ strict: false });
  ...
  const [scope, setScope] = useState<string>('lao-school');
...
export default ProgressTableLaoDistrict;
