...
const ProgressTableOBEC = () => {
  ...
  const [scope, setScope] = useState<string>('inspection-area');
  ...
  return (
    <div className="relative flex flex-col gap-5">
      <div hidden={!isFirstLoad} className="h-screen w-full">
        <CWALoadingOverlay visible={isFirstLoad} />
      </div>

      <div className={isFirstLoad ? 'hidden' : ''}>
        <CWBreadcrumbs
          links={[
            {
              label: 'รายงาน',
          ...
          <div className="flex flex-col gap-2">
            <div className="rounded-md p-2.5">
              <div className="flex gap-4">
                <p className="text-[26px] font-bold">{'Report สพฐ.'}</p>
              </div>
            </div>
...
export default ProgressTableOBEC;
