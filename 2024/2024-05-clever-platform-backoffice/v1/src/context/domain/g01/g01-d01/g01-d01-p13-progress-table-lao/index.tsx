...
const ProgressTableLao = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<string>('lao');
  ...
  const [scope, setScope] = useState<string>('province');
  const [parent_scope, setParentScope] = useState<string>('');
  const [report_type, setReportType] = useState<string>('lao');
          ...
          <div className="flex flex-col gap-2">
            <div className="rounded-md p-2.5">
              ...
              >
                ...
                <p className="text-[26px] font-bold">{'Report อปท.'}</p>
              </div>
            </div>
...
export default ProgressTableLao;
