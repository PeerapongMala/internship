...
const ProgressTableLaoSchool = () => {
  const navigate = useNavigate();
  const { province, district, school } = useParams({ strict: false });
          ...
          <div className="rounded-md p-2.5">
            <div className="flex gap-4">
              ...
              <p className="text-[26px] font-bold">
                {'Report อปท.'} / {province} / {district} / {school}
              </p>
            </div>
          </div>
...
export default ProgressTableLaoSchool;
