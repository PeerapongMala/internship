...
const ProgressTableLaoProvince = () => {
  const navigate = useNavigate();
  const { province } = useParams({ strict: false });
  ...
  const [scope, setScope] = useState<string>('lao-district');
  const [parent_scope, setParentScope] = useState<string>(province);
...
export default ProgressTableLaoProvince;
