...
const ProgressTableOther = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<string>('other');
  ...
  const [scope, setScope] = useState<string>('etc-school');
  const [parent_scope, setParentScope] = useState<string>('');
  const [report_type, setReportType] = useState<string>('others');
          ...
          <div className="flex flex-col gap-2">
            <div className="rounded-md p-2.5">
              ...
              >
                ...
                <p className="text-[26px] font-bold">{'Report'}</p>
              </div>
            </div>
...
export default ProgressTableOther;
