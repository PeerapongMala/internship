...
const ProgressTableOpec = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<string>('opec');
  ...
  const [scope, setScope] = useState<string>('opec-school');
  const [parent_scope, setParentScope] = useState<string>('');
  const [report_type, setReportType] = useState<string>('opec');
          ...
          <div className="flex flex-col gap-2">
            <div className="rounded-md p-2.5">
              ...
              >
                ...
                <p className="text-[26px] font-bold">{'Report สช.'}</p>
              </div>
            </div>
...
export default ProgressTableOpec;
