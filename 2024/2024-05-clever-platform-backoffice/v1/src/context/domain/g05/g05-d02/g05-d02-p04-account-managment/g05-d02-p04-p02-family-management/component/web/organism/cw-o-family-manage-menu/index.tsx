...
type FamilyCreateMenuProps = FamilyMenuProps & {};

/**
 * @props initialActiveTab : Active menu index
 */
const FamilyCreateMenu = ({ initialTab = 0, onTabChange }: FamilyCreateMenuProps) => {
...
export default FamilyCreateMenu;
