import { SubLesson } from '@domain/g05/g05-d03/local/types/overview';
...
const UnitLessonBarChart = ({ data = [] }: SubLessonProp) => {
  // const data = [50, 60, 70, 10, 30, 78, 98, 45, 35, 43];
  ...
  const categories = data?.map((item) => item.sub_lesson_name);
...
export default UnitLessonBarChart;
