...
export interface CreateHomeworkRequest {
  name: string;
  // empty string. not affect any thing
  homework_template_name: '';
  homework_template_subject_id: number;
  homework_template_year_id: number;
  homework_template_lesson_id: number;
  homework_template_status: string;
  subject_id: number;
  year_id: number;
  started_at: string;
  due_at: string;
