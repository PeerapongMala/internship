  ...
  return (
    ...
    >
      <div className="w-full">
        <div className={`flex w-full ${isMobile ? 'flex-col' : 'gap-5'} mb-5`}>
          <CWSelectValue
            ...
            title="ปีการศึกษา"
            className={isMobile ? 'mb-3 w-full' : 'w-[50%]'}
          />
          ...
          <CWSelectValue
            ...
            className={
              isMobile
                ? 'w-full'
                : `w-[50%] ${!filterSearch.academic_year ? 'cursor-not-allowed opacity-50' : ''}`
            }
              ...
              {fetching ? (
                ...
                <>
                  ...
                  >
                    ...
                    />
                    <div
                      className={`grid ${isMobile ? 'grid-cols-3 gap-2' : 'grid-cols-5'} w-full p-[10px] px-4`}
                    >
                      <div>รหัสห้อง</div>
                      {!isMobile && <div>ชื่อห้อง</div>}
                      <div>ชั้นปี</div>
                      {!isMobile && <div>ปีการศึกษา</div>}
                      <div>จำนวน</div>
                    </div>
                  </label>
                  ...
                  {records.map((item, index) => (
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          `grid ${isMobile ? 'grid-cols-3 gap-2' : 'grid-cols-5'} form-input h-10 w-full p-[10px] px-4 !font-normal hover:cursor-pointer hover:border-primary`,
                      ...
                      >
                        ...
                        {!isMobile && <div>{item.class_name}</div>}
                        <div>{item.class_year}</div>
                        {!isMobile && <div>{item.class_academic_year}</div>}
