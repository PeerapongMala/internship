        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white rounded shadow-md w-[400px] h-[450px] relative">
                ...
                <div className='w-full flex justify-center gap-5 absolute bottom-0 py-5 px-5'>
                    <button onClick={onClose} className='font-bold px-5 py-2 border rounded-md w-full'>ยกเลิก</button>
                    <button className='font-bold px-5 py-2 border rounded-md w-full text-white bg-primary shadow-lg'>ส่ง</button>
                </div>
