...
const Level = () => {
    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className='flex flex-col mt-5 w-full bg-gray-100 px-2 py-3 rounded-md '>
                <div className='flex'>
                    <img src="" alt="" />
            ...
            <div className='w-full mb-5'>
                <div className='my-5'>
                    <div className='flex gap-3'>
                        <button onClick={handleBack}><IconArrowBackward /></button>
                        <h1 className='font-bold text-[28px]'>บทเรียนย่อย</h1>
                    </div>
                    <p className='mt-2'>{number} บทเรียน</p>
                </div>

                <div className='w-full bg-gray-100 p-5 flex flex-col gap-3 rounded-md'>
                    <h1 className='font-bold text-[24px]'>บทที่ 1 จำนวนนับ</h1>
                    <p>ปีการศึกษา: 2567 / คณิตศาสตร์ / ป.4</p>
                </div>
