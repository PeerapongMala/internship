    ...
    return (
        <>
            ...
            <div className="grid grid-cols-[20%_80%] gap-2">
                ...
                <div>สถานะ:</div>
                <div><span className="badge badge-outline-info">แบบร่าง</span></div>
                ...
                <div>บทเรียนย่อย:</div>
                <div>อ่านและเขียนตัวเลขฮินดูอารบิก ตัวเลขไทย และตัวหนังสือแสดงจำนวนนับที่มากกว่า 100,000</div>
