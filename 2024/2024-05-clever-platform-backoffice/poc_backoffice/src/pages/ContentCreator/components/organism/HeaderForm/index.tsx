...
const HeaderForm = () => {
    ...
    const mockData = [
        { label: 'ID : 00001, กานดาได้รับเงินเดือนเดือนละ 20,000 บาท', index: 1, disabledUp: true },
        { label: 'ID : 00002, กานดาได้รับเงินเดือนเดือนละ 30,000 บาท', index: 2 },
        { label: 'ID : 00003, กานดาได้รับเงินเดือนเดือนละ 40,000 บาท', index: 3, disabledDown: true },
    ];
    return (
        <>
            <ModalQuestionOrder open={open} onClose={onClose} onOk={onOk} data={mockData} />
            <button className="btn btn-primary w-44 flex gap-2">
