                ...
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <SidebarMenu
                            ...
                            setErrorSubMenu={setErrorSubMenu}
                        />
                        {/* <DefaultSidebarMenu
                            currentMenu={currentMenu}
                            toggleMenu={toggleMenu}
...
const SidebarMenu = ({ currentMenu, toggleMenu, errorSubMenu, setErrorSubMenu }: {
    currentMenu: string,
    toggleMenu: (value: string) => void,
    errorSubMenu: boolean,
    setErrorSubMenu: (value: boolean) => void
}) => {
    const { t } = useTranslation();
    ...
    return (
        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
            <li className="nav-item">
                <ul>
                    <li className="nav-item">
                        <NavLink to="/content-creator/create-setting" className="group">
                            <div className="flex items-center">
                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('create_quiz')}</span>
                            </div>
                        </NavLink>
                    </li>
                </ul>
...
const DefaultSidebarMenu = ({ currentMenu, toggleMenu, errorSubMenu, setErrorSubMenu }: {
    currentMenu: string,
    toggleMenu: (value: string) => void,
    errorSubMenu: boolean,
    setErrorSubMenu: (value: boolean) => void
