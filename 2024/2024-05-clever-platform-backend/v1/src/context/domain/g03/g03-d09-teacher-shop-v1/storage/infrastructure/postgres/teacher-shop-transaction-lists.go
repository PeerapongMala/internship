...
func (postgresRepository *postgresRepository) TeacherShopTransactionList(pagination *helper.Pagination, filter *constant.TeacherShopListFilter, storeItemId int) (r []constant.ShopItemTransactionResponse, err error) {
	values := []interface{}{}
	query := `
