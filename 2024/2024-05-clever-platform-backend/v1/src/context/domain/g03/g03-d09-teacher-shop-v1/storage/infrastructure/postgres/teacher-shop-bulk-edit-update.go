...
func (postgresRepository *postgresRepository) TeacherShopUpdateStatusBulkEdit(items []constant.BulkEditList, updateBy string) (r []constant.ShopItemEntity, err error) {
	if len(items) == 0 {
		return r, nil
	}
