...
import (
	...
	domainService "github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g06/g06-d05-porphor5-v1/service"
	gradePorphor5Storage "github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g06/g06-d05-porphor5-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) domainService.ServiceInterface {
	...
	gradePorphor5Instance := gradePorphor5Storage.StorageNew(resource)
	authStorageInstance := authStorage.StorageNew(resource)
	cloudStorageInstance := cloudStorage.StorageNew(resource)

	serviceInstance := domainService.ServiceNew(gradeTemplateInstance, gradeFormInstance, gradeDataEntryInstance, gradePorphor5Instance, authStorageInstance, cloudStorageInstance)
