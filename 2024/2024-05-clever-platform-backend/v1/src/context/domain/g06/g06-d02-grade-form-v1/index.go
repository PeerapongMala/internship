...
import (
	...
	domainService "github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g06/g06-d02-grade-form-v1/service"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) domainService.ServiceInterface {
	...
	serviceInstance := domainService.ServiceNew(gradeTemplateInstance, gradeFormInstance, gradeDataEntryInstance, gradeSettingInstance, authStorageInstance, cloudStorageInstance)
