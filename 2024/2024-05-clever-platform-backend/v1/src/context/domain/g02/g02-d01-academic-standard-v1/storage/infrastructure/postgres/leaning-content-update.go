...
func (postgresRepository *postgresRepository) LearningContentUpdate(c constant.LearningContentUpdateRequest, txs ...*sqlx.Tx) error {
	...
	query := `UPDATE "curriculum_group"."learning_content"
	SET criteria_id = $1,
	name = $2,
	status = $3,
	updated_at = $4,
