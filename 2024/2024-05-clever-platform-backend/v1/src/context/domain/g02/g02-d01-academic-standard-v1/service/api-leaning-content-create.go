...
func (api *APIStruct) LearningContentCreate(context *fiber.Ctx) error {

	var body constant.LearningContentCreateRequest
	...
	err := api.Service.LearningContentCreate(constant.LearningContentCreateRequest{
	...
	if err != nil {
		...
		return context.Status(fiber.StatusInternalServerError).JSON(constant.StatusResponse{
			...
			Message:    "Cannot Create Learning Content",
		})
	}
	return context.Status(fiber.StatusCreated).JSON(constant.StatusResponse{
		StatusCode: fiber.StatusCreated,
		Message:    "Learning Content Created",
	})
}

func (service *serviceStruct) LearningContentCreate(c constant.LearningContentCreateRequest) error {
