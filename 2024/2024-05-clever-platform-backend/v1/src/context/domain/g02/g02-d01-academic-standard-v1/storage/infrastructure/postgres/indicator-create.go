...
func (postgresRepository *postgresRepository) IndicatorsCreate(c constant.IndicatorsCreateRequest, txs ...*sqlx.Tx) error {
	...
	query := ` INSERT INTO "curriculum_group"."indicator"(
	learning_content_id,
	name,
	short_name,
	transcript_name,
