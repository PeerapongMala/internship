...
func (postgresRepository *postgresRepository) LearningAreaCreate(c constant.LearningAreaCreateRequest, txs ...*sqlx.Tx) error {
	...
	query := `INSERT INTO "curriculum_group"."learning_area"(
	curriculum_group_id,
	year_id,
	name,
	status,
