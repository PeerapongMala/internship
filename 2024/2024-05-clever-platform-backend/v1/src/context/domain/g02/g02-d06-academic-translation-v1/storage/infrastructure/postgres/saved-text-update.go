...
func (postgresRepository *postgresRepository) SavedTextUpdate(tx *sqlx.Tx, savedText *constant.SavedTextUpdateEntity) (*constant.SavedTextEntity, error) {
