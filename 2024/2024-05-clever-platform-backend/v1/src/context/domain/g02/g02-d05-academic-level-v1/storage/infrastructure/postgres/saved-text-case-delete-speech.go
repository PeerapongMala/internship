...
func (postgresRepository *postgresRepository) SavedTextCaseDeleteSpeech(tx *sqlx.Tx, savedText *constant.SavedTextEntity) (*constant.SavedTextEntity, error) {
