...
func (api *APIStruct) EventAnnounceBulkEdit(context *fiber.Ctx) error {
	...
	err = api.Service.EventAnnounceBulkEdit(request, RolesCheck)
	if err != nil {
...
func (service *serviceStruct) EventAnnounceBulkEdit(req []constant.AnnounceBulkEdit, Role constant.CheckRoleRequest) error {
	var Admin *string
	...
	for _, v := range req {
		...
		err := service.GmannounceStorage.EventAnnounceBulkEdit(request, user)
		if err != nil {
