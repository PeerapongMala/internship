...
func (postgresRepository *postgresRepository) UpdateRewardAnnounce(c constant.UpdateRewardAnnounceRequest) error {
	...
	query := ` UPDATE "announcement"."announcement_reward"
	SET subject_id = $1,
	academic_year = $2
...
func (postgresRepository *postgresRepository) UpdateRewardItem(c constant.UpdateRewardItemRequest) error {
	query := ` UPDATE "announcement"."announcement_reward_item"
	SET item_id = $1,
	amount = $2,
	expired_at = $3
	WHERE announcemnet_reward_id = $4 AND item_id = $5
	`
