...
func (api *APIStruct) RewardAnnounceBulkEdit(context *fiber.Ctx) error {
	...
	err = api.Service.RewardAnnounceBulkEdit(request, RolesCheck)
	if err != nil {
...
func (service *serviceStruct) RewardAnnounceBulkEdit(req []constant.AnnounceBulkEdit, Role constant.CheckRoleRequest) error {
	var Admin *string
	...
	for _, v := range req {
		...
		err := service.GmannounceStorage.RewardAnnounceBulkEdit(request, user)
		if err != nil {
