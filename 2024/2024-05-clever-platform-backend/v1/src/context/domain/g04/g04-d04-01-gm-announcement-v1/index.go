...
import (
	...
	"github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g04/g04-d04-01-gm-announcement-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) (storageRepository.GmAnnounceRepository, service.ServiceInterface) {
