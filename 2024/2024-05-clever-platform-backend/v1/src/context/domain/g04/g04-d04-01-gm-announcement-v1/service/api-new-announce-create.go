...
func (api *APIStruct) AddNewsAnnounce(context *fiber.Ctx) error {
	var body constant.CreateNewsAnnounceRequest
	...
	err = api.Service.AddNewsAnnounce(body, RolesCheck)
	if err != nil {
...
func (service *serviceStruct) AddNewsAnnounce(c constant.CreateNewsAnnounceRequest, Role constant.CheckRoleRequest) error {
	var key *string
	if c.ImageFile != nil {
	...
	err := service.GmannounceStorage.AddNewsAnnounce(c)
	if err != nil {
		log.Printf("%+v", errors.WithStack(err))
		return err
	}
