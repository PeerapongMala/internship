...
func (postgresRepository *postgresRepository) EventAnnounceBulkEdit(req constant.AnnounceBulkEdit, c constant.User) error {
	query := `
	...
	updated_by = $3,
	admin_login_as = $4
	WHERE scope = 'Subject' AND type = 'event' AND id = $5 
	`
