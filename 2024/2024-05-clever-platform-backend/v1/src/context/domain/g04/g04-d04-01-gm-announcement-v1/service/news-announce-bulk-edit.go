...
func (api *APIStruct) NewsAnnounceBulkEdit(context *fiber.Ctx) error {
	...
	err = api.Service.NewsAnnounceBulkEdit(request, RolesCheck)
	if err != nil {
...
func (service *serviceStruct) NewsAnnounceBulkEdit(req []constant.AnnounceBulkEdit, Role constant.CheckRoleRequest) error {
	var Admin *string
	...
	for _, v := range req {
		...
		err := service.GmannounceStorage.NewsAnnounceBulkEdit(request, user)
		if err != nil {
