...
func (api *APIStruct) AddEventAnnounce(context *fiber.Ctx) error {
	var body constant.CreateEventAnnounceRequest
	...
	err = api.Service.AddEventAnnounce(body, RolesCheck)
	if err != nil {
...
func (service *serviceStruct) AddEventAnnounce(c constant.CreateEventAnnounceRequest, Role constant.CheckRoleRequest) error {
	var key *string
	if c.ImageFile != nil {
	...
	err := service.GmannounceStorage.AddEventAnnounce(c)
	if err != nil {
		log.Printf("%+v", errors.WithStack(err))
		return err
