...
type ShopRepository interface {
	...
	UpdateShopItemStatusBulkEdit(items []constant.BulkEditList, updateBy string) (r []constant.ShopItemEntity, err error)
	UpdateShopItemTransactionStatusBulkEdit(items []constant.BulkEditTransactionList) (r []constant.ShopItemTransactionEntity, err error)
