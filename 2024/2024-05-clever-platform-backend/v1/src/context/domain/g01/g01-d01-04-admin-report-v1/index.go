...
import (
	...
	"github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g01/g01-d01-04-admin-report-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) {
	...
	adminReportStorage := storage.StorageNew(resource)
	adminReportService := service.ServiceNew(adminReportStorage)
