...
func (postgresRepository *postgresRepository) LaoSchoolProgressList(pagination *helper.Pagination, startDate, endDate *time.Time, parentScope string) ([]constant.ProgressReport, error) {
	query := `
