...
func (postgresRepository *postgresRepository) SchoolProgressList(pagination *helper.Pagination, startDate, endDate *time.Time, parentScope string) ([]constant.ProgressReport, error) {
	query := `
