...
import (
	...
	"github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain/g01/g01-d00-01-global-announce-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) (storageRepository.AnnounceRepository, service.ServiceInterface) {
