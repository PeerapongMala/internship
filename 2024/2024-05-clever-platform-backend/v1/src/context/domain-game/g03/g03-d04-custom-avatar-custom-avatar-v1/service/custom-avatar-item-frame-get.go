...
func (api *APIStruct) GetCustomAvatarItemFrame(context *fiber.Ctx) error {
	...
	resp, err := api.Service.GetCustomAvatarItemFrame(data)
	if err != nil {
...
func (s serviceStruct) GetCustomAvatarItemFrame(c constant.GetInventoryAvatarItemRequest) (r []constant.InventoryAvatarItemEntity, err error) {
	items, err := s.customAvatarStorage.GetCustomAvatarItemFrame(c)
	if err != nil {
		return nil, err
	}
