...
func (api *APIStruct) UpdateCustomAvatarItemBadgeEquipped(context *fiber.Ctx) error {
	...
	resp, err := api.Service.UpdateCustomAvatarItemBadgeEquipped(data)
	if err != nil {
		return helper.RespondHttpError(context, err)
	}
...
func (s *serviceStruct) UpdateCustomAvatarItemBadgeEquipped(c constant.UpdateCustomAvatarItemEquippedRequest) (r constant.InventoryAvatarItemBadgeEntity, err error) {
	return s.customAvatarStorage.UpdateCustomAvatarItemBadgeEquipped(c)
}
