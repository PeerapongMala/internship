...
func (api *APIStruct) UpdateCustomAvatarItemCouponEquipped(context *fiber.Ctx) error {
	...
	resp, err := api.Service.UpdateCustomAvatarItemCouponEquipped(data)
	if err != nil {
		return helper.RespondHttpError(context, err)
	}
...
func (s *serviceStruct) UpdateCustomAvatarItemCouponEquipped(c constant.UpdateCustomAvatarItemEquippedRequest) (r constant.InventoryAvatarItemEntity, err error) {
	return s.customAvatarStorage.UpdateCustomAvatarItemCouponEquipped(c)
}
