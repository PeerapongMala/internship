...
import (
	...
	"github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain-game/g03/g03-d06-mail-box-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) (storageRepository.MailBoxRepository, service.ServiceInterface) {
