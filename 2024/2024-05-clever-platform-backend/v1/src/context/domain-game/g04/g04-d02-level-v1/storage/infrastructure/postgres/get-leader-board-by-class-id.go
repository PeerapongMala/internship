...
func (postgresRepository *postgresRepository) GetLeaderBoardByClassId(levelIds []int, classId int, startDate string, endDate string, pagination *helper.Pagination, userId string) ([]constant.LeaderBoardDataEntity, error) {
	query := `
		...
		ORDER BY global_rank;
	`
	args := []interface{}{levelIds, classId, startDate, endDate, userId, pagination.Offset, pagination.Limit}
