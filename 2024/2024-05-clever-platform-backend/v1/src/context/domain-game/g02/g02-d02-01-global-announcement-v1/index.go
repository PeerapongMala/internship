...
import (
	...
	"github.com/ZettaMerge/2024-05-clever-platform-backend/src/context/domain-game/g02/g02-d02-01-global-announcement-v1/storage"
...
func Init(app *fiber.App, resource coreInterface.Resource, path string) (storageRepository.GlobalAnnounceRepository, service.ServiceInterface) {
