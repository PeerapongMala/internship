...
func (postgresRespository *postgresRepository) SystemAnnouncementList(schoolId int, pagination *helper.Pagination) ([]constant.AnnouncementResponse, int, error) {
	query := `
	SELECT
	...
	AND "a"."scope" = 'School' AND "a"."type" = 'system'
