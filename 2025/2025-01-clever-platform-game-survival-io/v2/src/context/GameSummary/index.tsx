...
const GameSummary: React.FC = () => {
  ...
  // Pad with zeros
  let timeFormatted = `${String(minutes).padStart(2, '0')}:${String(seconds).padStart(
    2,
    '0',
  )}`;
    ...
    <div className="flex h-screen flex-col items-center justify-center">
      <div style={{ position: 'relative' }}>
        <img
          ...
          className="w-600px h-600px mb-8 object-center"
        />
        ...
        >
          <img
            ...
            alt="Last wars game logo"
            className="w-600px h-600px mb-8 scale-53 object-center"
          />
        </span>
        <span
          style={{
